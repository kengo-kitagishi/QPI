...
path = "/Volumes/QPI_0_.01_r/ph_21/Pos0/img_000000000_Default_000.tif"
...
# ディレクトリ設定
BASE_DIR = "/Volumes/QPI3/250910_kk/ph_1"
...
# Pos1〜Pos30 をループ
for pos_idx in range(2,44): #251019 1,46 #250910 1,44
    pos_name = f"Pos{pos_idx}"
    TARGET_DIR = os.path.join(BASE_DIR, pos_name)
